      ...
      <Container fullWidth>
        <div className="relative h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 text-center">
          ...
          <motion.div
            ...
            className="mb-6"
          >
            <span className="px-4 py-2 text-sm font-medium bg-white/10 text-white/90 backdrop-blur rounded-full border border-white/20 flex items-center gap-2">
              {/* <Icon icon="mdi:run" width="16" height="16" /> */}
              #untalentedrunners
            </span>
          </motion.div>
          ...
          <AnimatePresence mode="wait">
            <motion.h1
              ...
              className="text-4xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight text-white max-w-7xl mx-auto"
            >
