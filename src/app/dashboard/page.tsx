...
import type { MemberChartData, EventsChartData } from '@/components/dashboard/DashboardCharts';

const DashboardCharts = dynamic(() => import('@/components/dashboard/DashboardCharts'), { ssr: false });
const QRScannerModal = dynamic(
  () => import('@/components/ui/QRScannerModal').then((mod) => mod.QRScannerModal),
  { ssr: false }
);
...
export default function DashboardPage() {
  ...
  return (
    <div>
      ...
      {/* Charts Section */}
      <DashboardCharts chartLoading={chartLoading} membersChart={membersChart} eventsChart={eventsChart} filterYear={filterYear} />
